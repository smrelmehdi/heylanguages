  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-14 md:py-20">
      ...
      <p className="mt-5 text-lg leading-8 text-muted">
        You can request deletion of your HeyYusuf account by contacting
        HeyLanguages.
      </p>
      ...
      <div className="mt-10 rounded-lg border border-line bg-panel/82 p-6 shadow-soft md:p-8">
        ...
        <ol className="mt-5 space-y-4 pl-5 text-muted">
          <li>
            ...
            from the email address linked to your HeyYusuf account, if possible.
          </li>
          <li>
            Use the subject line <strong className="text-cream">Delete HeyYusuf Account</strong>.
          </li>
          <li>
      ...
      <div className="mt-8">
        <Notice title="Important subscription warning">
          ...
          through your Apple or Google account.
        </Notice>
      </div>
      ...
      <div className="mt-8 rounded-lg border border-line bg-panel/70 p-6">
        ...
        <p className="mt-3 leading-7 text-muted">
          Account deletion may remove or anonymize account details, learning
          progress, settings, and other information associated with your account,
          unless we need to keep limited information for legal, security, fraud
          prevention, or support reasons.
        </p>
        <p className="mt-4 leading-7 text-muted">
          Store purchase records are managed by Apple or Google. Subscription
          cancellation and refunds follow the store policies.
        </p>
      </div>
    </main>
  );
