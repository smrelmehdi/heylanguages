...
const styles = StyleSheet.create({
  ...
  avatar: { width: 64, height: 64, borderRadius: 32, backgroundColor: theme.colors.bgElevated, alignItems: 'center', justifyContent: 'center' },
  avatarInitial: { fontSize: 28, fontWeight: theme.fontWeight.medium, color: theme.colors.textPrimary },
  avatarInfo: { flex: 1 },
