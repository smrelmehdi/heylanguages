...
export const CAFE_DIALOGUE: DialogueTurn[] = [
  ...
  { type: 'waiter', arabic: 'اَلسَّلَامُ عَلَيْكُم',          transliteration: "as-salaamu 'alaykum",        english: 'Peace be upon you',       context: 'Waiter approaches smiling', audio: require('../assets/audio/cafe/w1.mp3') },
  { type: 'user',   arabic: 'وَعَلَيْكُم اَلسَّلَام',         transliteration: "wa 'alaykum as-salaam",      english: 'And upon you peace',                                                audio: require('../assets/audio/cafe/u1.mp3') },
  { type: 'waiter', arabic: 'كَيْفَ حَالَك؟',                 transliteration: 'kayf haalak?',               english: 'How are you?',                                                      audio: require('../assets/audio/cafe/w2.mp3') },
  { type: 'user',   arabic: 'بِخَيْر، اَللَّهُ يُسَلِّمَكَ', transliteration: 'bikhair, allah yisallimak',  english: 'Fine, God keep you safe',                                           audio: require('../assets/audio/cafe/u2.mp3') },
  { type: 'waiter', arabic: 'أَهْلاً وَسَهْلاً',              transliteration: 'ahlan wa sahlan',            english: 'Welcome',                                                           audio: require('../assets/audio/cafe/w3.mp3') },
  { type: 'user',   arabic: 'أَهْلاً بِيكَ',                  transliteration: 'ahlan biik',                 english: 'Welcome to you too',                                                audio: require('../assets/audio/cafe/u3.mp3') },
  { type: 'waiter', arabic: 'تَفَضَّلْ اِجْلِسْ',             transliteration: 'tafaddal ijlis',             english: 'Please have a seat',                                                audio: require('../assets/audio/cafe/w4.mp3') },
  { type: 'user',   arabic: 'مَشْكُور',                        transliteration: 'mashkoor',                   english: 'Thank you',                                                         audio: require('../assets/audio/cafe/u4.mp3') },
  // Part 2 — Ordering (index 8-17)
  { type: 'waiter', arabic: 'وِشْ تَبِي؟',                    transliteration: 'wish tabi?',                 english: 'What do you want?',       context: 'Gulf dialect: wish tabi',   audio: require('../assets/audio/cafe/w5.mp3') },
  { type: 'user',   arabic: 'أَبِي قَهْوَة',                  transliteration: 'abi qahwa',                  english: 'I want a coffee',         context: 'Gulf: abi not areed',       audio: require('../assets/audio/cafe/u5.mp3') },
  { type: 'waiter', arabic: 'عَرَبِي وِلَّا أَمْرِيكِي؟',    transliteration: "'arabi willa amriiki?",       english: 'Arabic or Americano?',                                              audio: require('../assets/audio/cafe/w6.mp3') },
  { type: 'user',   arabic: 'عَرَبِي مِن فَضْلَك',            transliteration: "'arabi min fadlak",           english: 'Arabic please',                                                     audio: require('../assets/audio/cafe/u6.mp3') },
  { type: 'waiter', arabic: 'بِسُكَّر؟',                      transliteration: 'bi-sukkar?',                 english: 'With sugar?',                                                       audio: require('../assets/audio/cafe/w7.mp3') },
  { type: 'user',   arabic: 'لَا، بِدُونْ سُكَّر',            transliteration: 'la, bidoon sukkar',          english: 'No, without sugar',                                                 audio: require('../assets/audio/cafe/u7.mp3') },
  { type: 'waiter', arabic: 'فِي شَيْ ثَانِي؟',               transliteration: 'fi shay thaani?',            english: 'Anything else?',                                                    audio: require('../assets/audio/cafe/w8.mp3') },
  { type: 'user',   arabic: 'لَا، يِكْفِي',                   transliteration: 'la, yikfi',                  english: 'No, that is enough',                                                audio: require('../assets/audio/cafe/u8.mp3') },
  { type: 'waiter', arabic: 'حَاضِر، لَحْظَة',                transliteration: 'haadir, lahza',              english: 'Sure, one moment',                                                  audio: require('../assets/audio/cafe/w9.mp3') },
  { type: 'user',   arabic: 'تِسْلَم',                         transliteration: 'tislam',                     english: 'Bless you',                                                         audio: require('../assets/audio/cafe/u9.mp3') },
  // Part 3 — Paying (index 18-23)
  { type: 'waiter', arabic: 'تَبِي اَلْحِسَاب؟',              transliteration: 'tabi al-hisaab?',            english: 'Do you want the bill?',                                             audio: require('../assets/audio/cafe/w10.mp3') },
  { type: 'user',   arabic: 'إِيه، بِكَم؟',                   transliteration: 'ih, bikam?',                 english: 'Yes, how much?',                                                    audio: require('../assets/audio/cafe/u10.mp3') },
  { type: 'waiter', arabic: 'عَشَرَة دَرَاهِم',               transliteration: "'ashara darahim",             english: 'Ten dirhams',                                                       audio: require('../assets/audio/cafe/w11.mp3') },
  { type: 'user',   arabic: 'تَفَضَّل، شُكْراً',              transliteration: 'tafaddal, shukran',          english: 'Here you go, thanks',                                               audio: require('../assets/audio/cafe/u11.mp3') },
  { type: 'waiter', arabic: 'مَعَ السَّلَامَة',                transliteration: "ma'a as-salaama",            english: 'Goodbye',                                                           audio: require('../assets/audio/cafe/w12.mp3') },
  { type: 'user',   arabic: 'اَللَّهُ يُسَلِّمَكَ',           transliteration: 'allah yisallimak',           english: 'May God keep you safe',                                             audio: require('../assets/audio/cafe/u12.mp3') },
];
