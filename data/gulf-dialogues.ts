...
export const CAFE_DIALOGUE: DialogueTurn[] = [
  ...
  { type: 'user',   arabic: 'بِخَيْر، اَللَّهُ يُسَلِّمَكَ', displayArabic: 'بخير، الله يسلمك',    audioText: 'بخير، الله يسلمك',    transliteration: 'bikhair, allah yisallimak',  english: 'Fine, God keep you safe',                                           audio: require('../assets/audio/cafe/u2.mp3') },
  ...
  { type: 'user',   arabic: 'أَهْلاً بِيكَ',                  displayArabic: 'الله يحييك',         audioText: 'الله يحييك',         transliteration: 'ahlan biik',                 english: 'Welcome to you too',                                                audio: require('../assets/audio/cafe/u3.mp3') },
  ...
  { type: 'user',   arabic: 'تِسْلَم',                         displayArabic: 'تسلم',              audioText: 'تسلم',              transliteration: 'tislam',                     english: 'Bless you',                                                         audio: require('../assets/audio/cafe/u9.mp3') },
  ...
  { type: 'user',   arabic: 'إِيه، بِكَم؟',                   displayArabic: 'إي، بكم؟',          audioText: 'إي، بكم؟',          transliteration: 'ih, bikam?',                 english: 'Yes, how much?',                                                    audio: require('../assets/audio/cafe/u10.mp3') },
