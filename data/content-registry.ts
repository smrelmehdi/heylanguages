...
const GULF_SCENE_IMAGES: Record<string, any> = {
  Cafe:            require('../assets/images/cafe-bg.webp'),
  CafeEntrance:    require('../assets/images/arabic-cafe-entrance.webp'),
  Taxi:            require('../assets/images/dubai-taxi-interior.webp'),
  TaxiEntrance:    require('../assets/images/dubai-taxi-street.webp'),
  ...
  WeatherChat:             require('../assets/images/dubai-weather-chat-interior.webp'),
  WeatherChatEntrance:     require('../assets/images/dubai-weather-chat-entrance.webp'),
  DoctorVisit:             require('../assets/images/dubai-doctor-visit-interior.webp'),
  DoctorVisitEntrance:     require('../assets/images/dubai-doctor-visit-entrance.webp'),
  AtBank:                  require('../assets/images/dubai-bank-interior.webp'),
  AtBankEntrance:          require('../assets/images/dubai-bank-entrance.webp'),
  ...
  NeighborVisit:           require('../assets/images/dubai-neighbor-visit-interior.webp'),
  NeighborVisitEntrance:   require('../assets/images/dubai-neighbor-visit-entrance.webp'),
  ...
  CarBreakdown:              require('../assets/images/dubai-car-breakdown-interior.webp'),
  CarBreakdownEntrance:      require('../assets/images/dubai-car-breakdown-entrance.webp'),
