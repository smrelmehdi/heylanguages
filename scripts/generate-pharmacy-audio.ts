...
const PHRASES = [
  ...
  { id: 'u1', text: 'وعليكم السلام، عندي صداع' },
  { id: 'w2', text: 'منذ متى؟' },
  { id: 'u2', text: 'من الصباح' },
  { id: 'w3', text: 'عندك حرارة؟' },
  { id: 'u3', text: 'ما أعرف، بس أحس تعبان' },
  { id: 'w4', text: 'تفضل هذا الدواء' },
  { id: 'u4', text: 'كيف آخذه؟' },
  { id: 'w5', text: 'حبة كل ست ساعات بعد الأكل' },
  { id: 'u5', text: 'زين، وبكم؟' },
  { id: 'w6', text: 'اثنا عشر درهم' },
  { id: 'u6', text: 'تفضل' },
  { id: 'w7', text: 'الله يشفيك' },
  { id: 'u7', text: 'آمين، مع السلامة' },
];

const outputDir = pathResolve('./assets/audio/pharmacy');
...
async function main() {
  ...
  console.log('🎉 All done! Files saved to assets/audio/pharmacy/');
}
