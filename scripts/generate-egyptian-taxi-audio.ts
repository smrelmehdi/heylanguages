...
const PHRASES = [
  { id: 'u1', text: 'السلام عليكم، فاضي يا أسطى؟' },
  { id: 'w1', text: 'أيوه اتفضل، رايح فين؟' },
  { id: 'u2', text: 'عايز أروح وسط البلد لو سمحت' },
  { id: 'w2', text: 'إن شاء الله، بس فيه زحمة شوية دلوقتي' },
  { id: 'u3', text: 'مفيش مشكلة' },
  { id: 'w3', text: 'هناخد طريق الكورنيش أحسن' },
  { id: 'u4', text: 'تمام يا أسطى' },
  { id: 'w4', text: 'وصلنا يا باشا' },
  { id: 'u5', text: 'الحساب بكام؟' },
  { id: 'w5', text: 'خمسة وتلاتين جنيه' },
  { id: 'u6', text: 'اتفضل، شكراً يا أسطى' },
  { id: 'w6', text: 'الله يسلمك يا باشا، مع السلامة' },
];

const outputDir = pathResolve('./assets/audio/egyptian/taxi');
...
async function main() {
  ...
  console.log('🎉 All done! Files saved to assets/audio/egyptian/taxi/');
}
