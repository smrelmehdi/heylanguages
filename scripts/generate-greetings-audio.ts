...
const PHRASES = [
  { id: '1',  text: 'مرحبا' },
  { id: '2',  text: 'أهلاً' },
  { id: '3',  text: 'السلام عليكم' },
  { id: '4',  text: 'وعليكم السلام' },
  { id: '5',  text: 'كيف حالك؟' },
  { id: '6',  text: 'بخير' },
  { id: '7',  text: 'الحمد لله' },
  { id: '8',  text: 'صباح الخير' },
  { id: '9',  text: 'صباح النور' },
  { id: '10', text: 'مساء الخير' },
  { id: '11', text: 'تشرفنا' },
  { id: '12', text: 'مع السلامة' },
  { id: '13', text: 'الله يسلمك' },
  { id: '14', text: 'يلا' },
  { id: '15', text: 'إن شاء الله' },
];

const outputDir = pathResolve('./assets/audio/greetings');
...
async function main() {
  ...
  console.log('🎉 All done! Files saved to assets/audio/greetings/');
}
