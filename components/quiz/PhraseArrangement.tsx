...
const styles = StyleSheet.create({
  ...
  submit: { alignSelf: 'center', backgroundColor: theme.colors.accentPrimary, borderRadius: theme.radii.pill, paddingHorizontal: 28, paddingVertical: 12 }, disabled: { opacity: 0.4 }, submitText: { color: theme.colors.bgBase, fontWeight: theme.fontWeight.medium }, feedback: { color: theme.colors.textSecondary, textAlign: 'center', fontSize: theme.fontSize.body },
});
