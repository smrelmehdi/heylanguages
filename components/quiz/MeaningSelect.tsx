...
const styles = StyleSheet.create({ container:{ gap:14 }, instruction:{ color:theme.colors.textSecondary,textAlign:'center',fontSize:theme.fontSize.heading }, arabic:{ color:theme.colors.textPrimary,textAlign:'center',fontSize:30,lineHeight:44,writingDirection:'rtl' }, options:{ gap:10 }, option:{ minHeight:58,borderWidth:1.5,borderColor:theme.colors.borderDefault,borderRadius:theme.radii.md,padding:14,justifyContent:'center' }, correct:{ borderColor:theme.colors.accentSuccess }, wrong:{ borderColor:theme.colors.accentDanger }, meaning:{ color:theme.colors.textPrimary,textAlign:'center',fontSize:theme.fontSize.body }, feedback:{ color:theme.colors.textSecondary,textAlign:'center' } });
