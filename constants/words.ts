...
export const BASIC_WORDS: Word[] = [
  ...
  { arabic: 'تَاكْسِي',    displayArabic: 'تاكسي',     audioText: 'تاكسي',     transliteration: 'taxi',          english: 'Taxi',              context: '🚕 Getting around Dubai',    example: 'أَبِي تَاكْسِي',         exampleTranslation: 'I want a taxi',              audio: require('../assets/audio/basic-words/5.mp3') },
  ...
  { arabic: 'أَنْتَ',       displayArabic: 'إنت',       audioText: 'إنت',       transliteration: 'anta',          english: 'You',               context: '👥 Talking to someone',      example: 'أَنْتَ زَيْن',           exampleTranslation: 'You are good',               audio: require('../assets/audio/basic-words/8.mp3') },
  ...
  { arabic: 'نَعَم',        displayArabic: 'إي',        audioText: 'إي',        transliteration: "na'am",         english: 'Yes',               context: '✅ Agreeing',                example: 'نَعَم، صَحّ',            exampleTranslation: 'Yes, correct',               audio: require('../assets/audio/basic-words/10.mp3') },
  ...
  { arabic: 'مِن فَضْلَك',  displayArabic: 'لو سمحت',   audioText: 'لو سمحت',   transliteration: 'min fadlak',    english: 'Please',            context: '🙏 Being polite',            example: 'مَاء مِن فَضْلَك',       exampleTranslation: 'Water please',               audio: require('../assets/audio/basic-words/13.mp3') },
  { arabic: 'مَاء',         displayArabic: 'ماي',       audioText: 'ماي',       transliteration: "maa'",          english: 'Water',             context: '💧 Essential words',         example: 'أَبِي مَاء',             exampleTranslation: 'I want water',               audio: require('../assets/audio/basic-words/14.mp3') },
  ...
  { arabic: 'اِثْنَيْن',    displayArabic: 'اثنين',     audioText: 'اثنين',     transliteration: 'ithnayn',       english: 'Two',               context: '🔢 Numbers',                 example: 'اِثْنَيْن دِرْهَم',      exampleTranslation: 'Two dirhams',                audio: require('../assets/audio/basic-words/18.mp3') },
