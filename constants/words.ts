...
export const BASIC_WORDS: Word[] = [
  ...
  { arabic: 'سَيَّارَة',    displayArabic: 'سيارة',     audioText: 'سيارة',     transliteration: 'sayyaara',      english: 'Car',               context: '🚗 Getting around',          example: 'سَيَّارَتِي هِنَا',      exampleTranslation: 'My car is here',             audio: require('../assets/audio/basic-words/4.mp3') },
  { arabic: 'تَاكْسِي',    displayArabic: 'تاكسي',     audioText: 'تاكسي',     transliteration: 'taksi',         english: 'Taxi',              context: '🚕 Getting around Dubai',    example: 'أَبِي تَاكْسِي',         exampleTranslation: 'I want a taxi',              audio: require('../assets/audio/basic-words/5.mp3') },
  ...
  { arabic: 'نَعَم',        displayArabic: 'إي',        audioText: 'إي',        transliteration: 'ee',            english: 'Yes',               context: '✅ Agreeing',                example: 'نَعَم، صَحّ',            exampleTranslation: 'Yes, correct',               audio: require('../assets/audio/basic-words/10.mp3') },
  ...
  { arabic: 'مَاء',         displayArabic: 'ماي',       audioText: 'ماي',       transliteration: 'maay',          english: 'Water',             context: '💧 Essential words',         example: 'أَبِي مَاء',             exampleTranslation: 'I want water',               audio: require('../assets/audio/basic-words/14.mp3') },
  { arabic: 'أَكْل',        displayArabic: 'أكل',       audioText: 'أكل',       transliteration: 'akl',           english: 'Food',              context: '🍽️ Eating in Dubai',        example: 'اَلْأَكْل زَيْن',        exampleTranslation: 'The food is good',           audio: require('../assets/audio/basic-words/15.mp3') },
...
export const INTRO_WORDS: Word[] = [
  { arabic: 'اِسْمِي',     displayArabic: 'شسمك؟',            audioText: 'شسمك؟',            transliteration: 'shismak?',              english: 'What’s your name?',                    context: '👋 First question',              example: 'شسمك؟ أنا يوسف',                    exampleTranslation: 'What’s your name? I’m Yusuf',                    audio: require('../assets/audio/intro/1.mp3') },
  ...
  { arabic: 'مَا عِنْدِي', displayArabic: 'فرصة سعيدة',        audioText: 'فرصة سعيدة',        transliteration: "fursa sa'eeda",          english: 'Nice to meet you',                     context: '🤝 First meeting',                example: 'فرصة سعيدة يا يوسف',               exampleTranslation: 'Nice to meet you, Yusuf',                    audio: require('../assets/audio/intro/15.mp3') },
];
